...
function CourseCard({ data }) {
  ...
  return (
    <div
      onClick={() => navigate("/course/description/", { state: { ...data } })} // useNavigate m state or data bhi pass ho jata hai pdna hai
    ...
    >
      <div className="overflow-hidden">
        ...
        <div className="p-3 space-y-1 text-white">
          ...
          <p className="font-semibold ">
            <span className="text-yellow-500 font-bold">Tota Lectures :</span>
