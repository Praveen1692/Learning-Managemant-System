...
function Checkout() {
  ...
  async function handleSubscription(e) {
    ...
    if (!razorpaykey || !subscription_id) {
      toast.error("Something Wrong.. razorpaykey subscription_id not found");
      return;
    }
    const options = {
      key: razorpaykey,
      ...
      handler: async function (response) {
        ...
        paymentsDetails.razorpay_subscription_id =
      ...
      >
        <div className="w-80 h-[26rem] flex flex-col justify-center shadow-[0_0_10px_black] rounded-lg relative">
          ...
          <div className="px-4 space-y-5 text-center">
            ...
            <button
              type="submit"
              className="bg-yellow-500 hover:bg-yellow-600 text-xl font-bold rounded-sm py-2    transition-all ease-in-out duration-300 absolute bottom-0 w-full left-0 "
            >
              Buy Now
            </button>
          </div>
